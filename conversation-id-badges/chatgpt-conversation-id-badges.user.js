...
// @require      https://raw.githubusercontent.com/Nicodemus75/chatgpt-userscripts/conversation-id-badges-testing/conversation-id-badges/header-v058.js
// @description  Staging build: stable v0.4.6 sidebar badges plus a header layer that adds only a badge beside native titles and uses a left-side project-control fallback when ChatGPT omits the chat title. No ChatGPT API calls.
