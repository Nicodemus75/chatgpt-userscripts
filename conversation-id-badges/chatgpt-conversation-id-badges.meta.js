...
// @description  Staging rebuild: stable sidebar badges plus persistent header identity with title sanitization and hard right-side control protection. DOM-only; no ChatGPT API calls.
