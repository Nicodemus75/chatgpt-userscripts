...
// @description  Staging rebuild: stable sidebar badges plus persistent header identity with action-safe width and opaque native-surface title rendering. DOM-only; no ChatGPT API calls.
