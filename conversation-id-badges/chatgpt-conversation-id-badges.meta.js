...
// @description  Staging rebuild: stable sidebar badges plus persistent header identity using the actual sidebar title leaf, preventing Work/timestamp/+0 metadata from entering the header. DOM-only; no ChatGPT API calls.
