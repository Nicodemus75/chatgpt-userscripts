...
// @description  Staging rebuild: stable sidebar badges plus persistent header identity. Native complete breadcrumbs are badge-only; missing-title headers get one sanitized title plus badge. DOM-only; no ChatGPT API calls.
