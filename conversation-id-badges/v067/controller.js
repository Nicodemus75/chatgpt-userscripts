(() => {
  ...
  class HeaderController {
    ...
    refresh() {
      ...
      // Use the exact clean chat title as the primary native-completeness test.
      // The slash/breadcrumb heuristic remains only as a secondary signal.
      const nativeComplete =
        this.adapter.nativeTitlePresentAnywhere(mountInfo.headerRoot, title) ||
        this.adapter.hasNativeConversationBreadcrumb?.(mountInfo.headerRoot) === true;
